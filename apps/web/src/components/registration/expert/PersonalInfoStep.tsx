...
const COUNTRIES = [
  { code: 'CN', name: { en: 'China', zh: '中国', vi: 'Trung Quốc' } },
  { code: 'US', name: { en: 'United States', zh: '美国', vi: 'Mỹ' } },
  { code: 'DE', name: { en: 'Germany', zh: '德国', vi: 'Đức' } },
  { code: 'JP', name: { en: 'Japan', zh: '日本', vi: 'Nhật Bản' } },
  { code: 'KR', name: { en: 'South Korea', zh: '韩国', vi: 'Hàn Quốc' } },
  { code: 'TW', name: { en: 'Taiwan', zh: '中国台湾', vi: 'Đài Loan' } },
  { code: 'HK', name: { en: 'Hong Kong', zh: '中国香港', vi: 'Hồng Kông' } },
  { code: 'SG', name: { en: 'Singapore', zh: '新加坡', vi: 'Singapore' } },
  { code: 'MY', name: { en: 'Malaysia', zh: '马来西亚', vi: 'Malaysia' } },
  { code: 'TH', name: { en: 'Thailand', zh: '泰国', vi: 'Thái Lan' } },
  { code: 'VN', name: { en: 'Vietnam', zh: '越南', vi: 'Việt Nam' } },
  { code: 'IN', name: { en: 'India', zh: '印度', vi: 'Ấn Độ' } },
  { code: 'GB', name: { en: 'United Kingdom', zh: '英国', vi: 'Anh' } },
  { code: 'FR', name: { en: 'France', zh: '法国', vi: 'Pháp' } },
  { code: 'IT', name: { en: 'Italy', zh: '意大利', vi: 'Ý' } },
  { code: 'CH', name: { en: 'Switzerland', zh: '瑞士', vi: 'Thụy Sĩ' } },
  { code: 'AT', name: { en: 'Austria', zh: '奥地利', vi: 'Áo' } },
  { code: 'SE', name: { en: 'Sweden', zh: '瑞典', vi: 'Thụy Điển' } },
  { code: 'DK', name: { en: 'Denmark', zh: '丹麦', vi: 'Đan Mạch' } },
  { code: 'NL', name: { en: 'Netherlands', zh: '荷兰', vi: 'Hà Lan' } },
  { code: 'BE', name: { en: 'Belgium', zh: '比利时', vi: 'Bỉ' } },
  { code: 'AU', name: { en: 'Australia', zh: '澳大利亚', vi: 'Úc' } },
  { code: 'CA', name: { en: 'Canada', zh: '加拿大', vi: 'Canada' } },
  { code: 'BR', name: { en: 'Brazil', zh: '巴西', vi: 'Brazil' } },
  { code: 'MX', name: { en: 'Mexico', zh: '墨西哥', vi: 'Mexico' } },
  { code: 'RU', name: { en: 'Russia', zh: '俄罗斯', vi: 'Nga' } },
  { code: 'SA', name: { en: 'Saudi Arabia', zh: '沙特阿拉伯', vi: 'Ả Rập Saudi' } },
  { code: 'AE', name: { en: 'United Arab Emirates', zh: '阿联酋', vi: 'UAE' } },
  { code: 'ID', name: { en: 'Indonesia', zh: '印度尼西亚', vi: 'Indonesia' } },
  { code: 'PH', name: { en: 'Philippines', zh: '菲律宾', vi: 'Philippines' } },
  { code: 'PL', name: { en: 'Poland', zh: '波兰', vi: 'Ba Lan' } },
  { code: 'TR', name: { en: 'Turkey', zh: '土耳其', vi: 'Thổ Nhĩ Kỳ' } },
  { code: 'ZA', name: { en: 'South Africa', zh: '南非', vi: 'Nam Phi' } },
  { code: 'EG', name: { en: 'Egypt', zh: '埃及', vi: 'Ai Cập' } },
  { code: 'NG', name: { en: 'Nigeria', zh: '尼日利亚', vi: 'Nigeria' } },
  { code: 'XX', name: { en: 'Other', zh: '其他', vi: 'Khác' } },
];
